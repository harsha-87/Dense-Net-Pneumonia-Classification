...
# Dense-Net-Pneumonia-Classification
This project implements an AI-based system to automatically detect Pneumonia from Chest X-Ray images using a DenseNet121 deep learning model.
